function [trainedClassifier, validationAccuracy] = ThreeLayerNN_CLS(trainingData, responseData)
...
% Auto-generated by MATLAB on 23-Jun-2022 11:01:16
...
[validationPredictions, validationScores] = predict(trainedClassifier.ClassificationNeuralNetwork, predictors);

% Compute resubstitution accuracy
validationAccuracy = 1 - resubLoss(trainedClassifier.ClassificationNeuralNetwork, 'LossFun', 'ClassifError');
